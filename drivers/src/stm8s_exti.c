 ...
 * @version V2.3.0
 * @date    16-June-2017
 * @brief   This file contains all the functions for the T_EXTI peripheral.
 ******************************************************************************
 * @attention
 *
...
{
  T_EXTI->CR1 = EXTI_CR1_RESET_VALUE;
  T_EXTI->CR2 = EXTI_CR2_RESET_VALUE;
}
...
void EXTI_SetExtIntSensitivity(EXTI_Port_TypeDef Port, EXTI_Sensitivity_TypeDef SensitivityValue)
{
  ...
  {
  case EXTI_GPIOA:
    T_EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PAIS);
    T_EXTI->CR1 |= (uint8_t)(SensitivityValue);
    break;
  case EXTI_GPIOB:
    T_EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PBIS);
    T_EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 2);
    break;
  case EXTI_GPIOC:
    T_EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PCIS);
    T_EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 4);
    break;
  case EXTI_GPIOD:
    T_EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PDIS);
    T_EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 6);
    break;
  case EXTI_GPIOE:
    T_EXTI->CR2 &= (uint8_t)(~EXTI_CR2_PEIS);
    T_EXTI->CR2 |= (uint8_t)(SensitivityValue);
    break;
  default:
    break;
  }
...
void EXTI_SetTLISensitivity(EXTI_TLISensitivity_TypeDef SensitivityValue)
{
  ...
  T_EXTI->CR2 &= (uint8_t)(~EXTI_CR2_TLIS);
  T_EXTI->CR2 |= (uint8_t)(SensitivityValue);
}
...
EXTI_Sensitivity_TypeDef EXTI_GetExtIntSensitivity(EXTI_Port_TypeDef Port)
{
  ...
  {
  case EXTI_GPIOA:
    value = (uint8_t)(T_EXTI->CR1 & EXTI_CR1_PAIS);
    break;
  case EXTI_GPIOB:
    value = (uint8_t)((uint8_t)(T_EXTI->CR1 & EXTI_CR1_PBIS) >> 2);
    break;
  case EXTI_GPIOC:
    value = (uint8_t)((uint8_t)(T_EXTI->CR1 & EXTI_CR1_PCIS) >> 4);
    break;
  case EXTI_GPIOD:
    value = (uint8_t)((uint8_t)(T_EXTI->CR1 & EXTI_CR1_PDIS) >> 6);
    break;
  case EXTI_GPIOE:
    value = (uint8_t)(T_EXTI->CR2 & EXTI_CR2_PEIS);
    break;
  default:
    break;
  }
...
EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
{
  ...
  value = (uint8_t)(T_EXTI->CR2 & EXTI_CR2_TLIS);

  return ((EXTI_TLISensitivity_TypeDef)value);
}

const EXTI_Module EXTI = {
    .setSensitivity = EXTI_SetExtIntSensitivity,
};
