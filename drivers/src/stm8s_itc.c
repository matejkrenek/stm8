 ...
 * @version V2.3.0
 * @date    16-June-2017
 * @brief   This file contains all the functions for the T_ITC peripheral.
 ******************************************************************************
 * @attention
 *
...
/**
 * @brief  Deinitializes the T_ITC registers to their default reset value.
 * @param  None
 * @retval None
 */
void ITC_DeInit(void)
{
  T_ITC->ISPR1 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR2 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR3 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR4 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR5 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR6 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR7 = ITC_SPRX_RESET_VALUE;
  T_ITC->ISPR8 = ITC_SPRX_RESET_VALUE;
}
...
ITC_PriorityLevel_TypeDef ITC_GetSoftwarePriority(ITC_Irq_TypeDef IrqNum)
{
  ...
  case ITC_IRQ_CLK:
  case ITC_IRQ_GPIOA:
    Value = (uint8_t)(T_ITC->ISPR1 & Mask); /* Read software priority */
    break;
  ...
  case ITC_IRQ_GPIOD:
  case ITC_IRQ_GPIOE:
    Value = (uint8_t)(T_ITC->ISPR2 & Mask); /* Read software priority */
    break;
  ...
  case ITC_IRQ_TIM1_OVF:
    Value = (uint8_t)(T_ITC->ISPR3 & Mask); /* Read software priority */
    break;
  ...
  case ITC_IRQ_TIM3_OVF:
    Value = (uint8_t)(T_ITC->ISPR4 & Mask); /* Read software priority */
    break;
...
#endif /*STM8AF622x */
  case ITC_IRQ_I2C:
    Value = (uint8_t)(T_ITC->ISPR5 & Mask); /* Read software priority */
    break;
...
#endif                                      /*STM8S903 or STM8AF622x */
    Value = (uint8_t)(T_ITC->ISPR6 & Mask); /* Read software priority */
    break;

  case ITC_IRQ_EEPROM_EEC:
    Value = (uint8_t)(T_ITC->ISPR7 & Mask); /* Read software priority */
    break;
...
#endif /* STM8S903 or STM8AF622x */
    T_ITC->ISPR6 &= Mask;
    T_ITC->ISPR6 |= NewPriority;
    break;

  case ITC_IRQ_EEPROM_EEC:
    T_ITC->ISPR7 &= Mask;
    T_ITC->ISPR7 |= NewPriority;
    break;
