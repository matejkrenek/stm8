 ...
 * @version V2.3.0
 * @date    16-June-2017
 * @brief   This file contains all functions prototypes and macros for the T_UART1 peripheral.
 ******************************************************************************
 * @attention
 *
...
/**
 * @brief  T_UART1 LIN Break detection length possible values
 */
typedef enum
{
...
/**
 * @brief  T_UART1 stop bits possible values
 */
...
/**
 * @brief  T_UART1 parity possible values
 */
typedef enum
{
...
/**
 * @brief  T_UART1 Word length possible values
 */
typedef enum
{
...
/**
 * @brief  T_UART1 Mode possible values
 */
typedef enum
{
...
/**
 * @brief  T_UART1 Flag possible values
 */
typedef enum
{
...
/**
 * @brief  T_UART1 Interrupt definition
...
#define IS_UART1_SYNCMODE_OK(SyncMode) \
  (!((((SyncMode) & (((uint8_t)UART1_SYNCMODE_CLOCK_ENABLE) | ((uint8_t)UART1_SYNCMODE_CLOCK_DISABLE))) == (((uint8_t)UART1_SYNCMODE_CLOCK_ENABLE) | ((uint8_t)UART1_SYNCMODE_CLOCK_DISABLE))) || (((SyncMode) & (((uint8_t)UART1_SYNCMODE_CPOL_LOW) | ((uint8_t)UART1_SYNCMODE_CPOL_HIGH))) == (((uint8_t)UART1_SYNCMODE_CPOL_LOW) | ((uint8_t)UART1_SYNCMODE_CPOL_HIGH))) || (((SyncMode) & (((uint8_t)UART1_SYNCMODE_CPHA_MIDDLE) | ((uint8_t)UART1_SYNCMODE_CPHA_BEGINING))) == (((uint8_t)UART1_SYNCMODE_CPHA_MIDDLE) | ((uint8_t)UART1_SYNCMODE_CPHA_BEGINING))) || (((SyncMode) & (((uint8_t)UART1_SYNCMODE_LASTBIT_DISABLE) | ((uint8_t)UART1_SYNCMODE_LASTBIT_ENABLE))) == (((uint8_t)UART1_SYNCMODE_LASTBIT_DISABLE) | ((uint8_t)UART1_SYNCMODE_LASTBIT_ENABLE)))))
