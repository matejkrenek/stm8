 ...
 * @version V2.3.0
 * @date    16-June-2017
 * @brief   This file contains all functions prototype and macros for the T_ITC peripheral.
 ******************************************************************************
 * @attention
 *
...
/**
 * @brief  T_ITC Interrupt Lines selection
 */
typedef enum
{
  ...
  ITC_IRQ_GPIOA = (uint8_t)3, /*!< Port A external interrupts */
  ITC_IRQ_GPIOB = (uint8_t)4, /*!< Port B external interrupts */
  ITC_IRQ_GPIOC = (uint8_t)5, /*!< Port C external interrupts */
  ITC_IRQ_GPIOD = (uint8_t)6, /*!< Port D external interrupts */
  ITC_IRQ_GPIOE = (uint8_t)7, /*!< Port E external interrupts */
  ...
  ITC_IRQ_TIM6_OVFTRI = (uint8_t)23, /*!< TIM6 update/overflow/underflow/trigger/
                                     interrupt */
#else
  ITC_IRQ_TIM4_OVF = (uint8_t)23,    /*!< T_TIM4 update /overflow interrupt */
#endif /*STM8S903 or STM8AF622x */
...
/**
 * @brief  T_ITC Priority Levels selection
 */
typedef enum
{
  LEVEL_0 = (uint8_t)0x02, /*!< Software priority level 0 (cannot be written) */
  LEVEL_1 = (uint8_t)0x01, /*!< Software priority level 1 */
  LEVEL_2 = (uint8_t)0x00, /*!< Software priority level 2 */
  LEVEL_3 = (uint8_t)0x03  /*!< Software priority level 3 */
...
#define IS_ITC_PRIORITY_OK(PriorityValue) \
  (((PriorityValue) == LEVEL_0) ||        \
   ((PriorityValue) == LEVEL_1) ||        \
   ((PriorityValue) == LEVEL_2) ||        \
   ((PriorityValue) == LEVEL_3))
