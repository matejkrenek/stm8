...
#define _SDCC_
#define SDCC_VERSION (__SDCC_VERSION_MAJOR * 10000 + __SDCC_VERSION_MINOR * 100 + __SDCC_VERSION_PATCH)
#else
...
/*----------------------------------------------------------------------------*/
/**
 * @brief  Interrupt Controller (T_ITC)
 */
...
/*----------------------------------------------------------------------------*/
/**
 * @brief  External Interrupt Controller (T_EXTI)
 */
...
#define T_EXTI ((EXTI_TypeDef *)EXTI_BaseAddress)
...
#define T_ITC ((ITC_TypeDef *)ITC_BaseAddress)
